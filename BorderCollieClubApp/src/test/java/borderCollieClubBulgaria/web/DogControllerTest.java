...
public class DogControllerTest {
    ...
    @Test
    @WithAnonymousUser
    void get_Add_Dog_By_Anonymous_Redirects_To_Login() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void get_All_Anonymous_User_Returns_Proper_View() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void test_Add_Dog_Without_User_Returns_Redirect_Login() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void test_Add_Dog_Without_User_With_Errors_Returns_Redirect_Login() throws Exception {
        mockMvc.perform(post("/dogs/new")
                        .param("name", "").
                        param("gender", "").
                        param("kennelName", "").
