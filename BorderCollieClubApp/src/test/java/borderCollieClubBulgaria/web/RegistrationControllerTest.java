...
public class RegistrationControllerTest {
    ...
    @Test
    void get_Registration_Page_Shown() throws Exception {
    ...
    @Test
    void post_User_Registration_Error() throws Exception {
    ...
    @Test
    void post_User_Registration_Success() throws Exception {
        mockMvc.perform(post("/users/register")
                        .param("username", "gosho").
                        param("email", "test@ysy.bg").
                        param("firstName", "Gosho").
