package borderCollieClubBulgaria.web.interceptor;
...
@Component
public class MethodInvokeInterceptor implements HandlerInterceptor {
    private Logger LOG = LoggerFactory.getLogger(MethodInvokeInterceptor.class);
